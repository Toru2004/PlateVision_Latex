...
\begin{itemize}
    \item \textbf{Thời gian vào}: 5000 milliseconds (5 giây), đảm bảo đủ thời gian để hệ thống xử lý hình ảnh ô tô có kích thước lớn hơn.
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.5\textwidth]{graphics/main/chapter2/quet_o_to_result.jpg}
...
\begin{itemize}
    \item \textbf{Thời gian}: Thời gian vào được ghi nhận lúc 06:11:12 và thời gian ra lúc 06:32:25, cho phép quản lý thời gian đỗ xe hiệu quả.
