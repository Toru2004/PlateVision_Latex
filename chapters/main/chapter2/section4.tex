...
\subsubsection{Các thành phần chính của hệ thống}

Về tổng thể, hệ thống bao gồm 7 thành phần chính như sau:

\begin{itemize}
    \item \textbf{Trạm quét (desktop app):} 
    Được triển khai tại cổng ra/vào và do bảo vệ vận hành. Đây là thành phần trung tâm xử lý AI, thực hiện thu nhận hình ảnh và nhận diện biển số xe.

    \item \textbf{Ứng dụng Mobile:} 
    Phục vụ hai nhóm người dùng với hai giao diện riêng biệt:
    \begin{itemize}
        \item \textbf{Sinh viên:} dùng để quản lý phương tiện cá nhân và xem lịch sử ra/vào bãi xe.
        \item \textbf{Bảo vệ:} dùng để giám sát hệ thống và xử lý các tình huống đặc biệt.
    \end{itemize}

    \item \textbf{Web Dashboard (dành cho quản trị viên):} 
    Cho phép quản lý toàn bộ hệ thống, người dùng, phương tiện và theo dõi trạng thái bãi xe.

    \item \textbf{Firebase:} 
    Cung cấp các dịch vụ nền tảng bao gồm:
    \begin{itemize}
        \item \textbf{Authentication:} xác thực người dùng.
        \item \textbf{Firestore:} lưu trữ dữ liệu lịch sử ra/vào.
        \item \textbf{Realtime Database:} quản lý bãi đỗ ảo và đồng bộ trạng thái theo thời gian thực.
    \end{itemize}

    \item \textbf{Cloudinary:} 
    Dùng để lưu trữ hình ảnh phương tiện được chụp tại trạm quét.

    \item \textbf{Camera:} 
    Có nhiệm vụ thu thập hình ảnh phương tiện tại cổng ra/vào.

    \item \textbf{Thiết bị IoT điều khiển cổng:} 
    Nhận tín hiệu từ hệ thống và thực hiện đóng/mở cổng tự động.
\end{itemize}

Tất cả các thành phần trên giao tiếp với nhau thông qua Internet, đảm bảo khả năng đồng bộ dữ liệu theo thời gian thực.

\subsubsection{Luồng hoạt động của hệ thống}

Luồng hoạt động cơ bản của hệ thống được mô tả theo các bước sau:

\begin{enumerate}
    \item Khi phương tiện tiếp cận cổng vào, camera tự động thu nhận hình ảnh và gửi về \textbf{trạm quét}.

    \item Tại trạm quét, mô hình học máy (ML) thực hiện nhận diện biển số xe từ hình ảnh đầu vào.

    \item Kết quả nhận diện được đối chiếu với dữ liệu trên Firebase để:
    \begin{itemize}
        \item Xác thực quyền vào bãi.
        \item Kiểm tra số lượt vào còn lại.
    \end{itemize}

    \item Nếu hợp lệ, hệ thống thực hiện đồng thời các thao tác:
    \begin{itemize}
        \item Cập nhật trạng thái mở cổng lên Realtime Database.
        \item Thiết bị IoT nhận tín hiệu và điều khiển cổng mở.
        \item Ghi thông tin xe vào:
        \begin{itemize}
            \item Realtime Database: đóng vai trò bãi đỗ ảo.
            \item Firestore: lưu lịch sử ra/vào.
        \end{itemize}
        \item Ứng dụng Mobile của sinh viên nhận cập nhật trạng thái theo thời gian thực.
        \item Số lượt còn lại của sinh viên tự động bị trừ.
    \end{itemize}

    \item Khi phương tiện ra khỏi bãi:
    \begin{itemize}
        \item Nếu sinh viên đã nhấn nút ``Chuẩn bị rời đi'' trên ứng dụng:
        \begin{itemize}
            \item Hệ thống cho phép xe ra.
            \item Thông tin xe được xóa khỏi Realtime Database.
        \end{itemize}

        \item Nếu xe cố gắng ra mà chưa có yêu cầu rời đi:
        \begin{itemize}
            \item Hệ thống kích hoạt cảnh báo tức thì.
            \item Thông báo được gửi đến:
            \begin{itemize}
                \item Ứng dụng Mobile của sinh viên.
                \item Ứng dụng của bảo vệ.
                \item Trang quản trị của admin.
            \end{itemize}
        \end{itemize}
    \end{itemize}
\end{enumerate}
...
\end{tabular}
\end{table}
Dưới đây là bảng so sánh định tính giữa phương pháp đề xuất và các phương pháp truyền thống trong nhận dạng ký tự trên biển số xe.

\begin{table}[H]
\centering
\caption{So sánh kết quả nhận dạng giữa CNN OCR và EasyOCR}
\begin{tabular}{|c|c|c|c|c|c|}
\hline
\textbf{STT} & \textbf{Ảnh} & \textbf{CNN OCR} & \textbf{Đánh giá} & \textbf{EasyOCR} & \textbf{Đánh giá} \\
\hline
1  & 67AK22129.jpg & 67AK22129 & Đúng & 26271A2K9 & Sai \\ \hline
2  & 63AC16019.jpg & 63AC16019 & Đúng & 6630A1C9 & Sai \\ \hline
3  & 86AE02258.jpg & 86AE02258 & Đúng & 67A5E8 & Sai \\ \hline
4  & 70B194176.jpg & 70B194176 & Đúng & 701B716 & Sai \\ \hline
5  & 77AF08864.jpg & 77AF08864 & Đúng & 878A6 & Sai \\ \hline
6  & 62K155126.jpg & 62K155126 & Đúng & 62K1 & Sai \\ \hline
7  & 62AP09936.jpg & 62AP09936 & Đúng & 06929A3P6 & Sai \\ \hline
8  & 60YT6240.jpg & 66024Y01 & Sai & 60YT6240 & Đúng \\ \hline
9  & 59GA21257.jpg & 25192G5A7 & Sai & 59GA21257 & Đúng \\ \hline
10 & 66FA16301.jpg & 16663F0A1 & Sai & 66FA16301 & Đúng \\ \hline
11 & 77H160392.jpg & 77H160392 & Đúng & 70B194176 & Sai \\ \hline
12 & 50N23419.jpg & 50N829 & Sai & 50N234189 & Sai \\ \hline
13 & 63B56396.jpg & 66339B554 & Sai & 63B563956 & Sai \\ \hline
14 & 76X59158.jpg & 76X59158 & Đúng & 7615X85 & Sai \\ \hline
15 & 79H108261.jpg & 79H108261 & Đúng & 9H108261791 & Sai \\ \hline
16 & 68KA17220.jpg & 06930A2H9 & Sai & 6KA1220 & Sai \\ \hline
17 & 62AP09936.jpg & 06929A3P6 & Sai & 62AP09936 & Đúng \\ \hline
18 & 67AH02328.jpg & 67AH02328 & Đúng & 936116461 & Sai \\ \hline
19 & 71AG00241.jpg & 712AG1 & Sai & 71AG00241 & Đúng \\ \hline
20 & 59GA21257.jpg & 59GA21257 & Đúng & 25192G5A7 & Sai \\ \hline
\end{tabular}
\end{table}

\textbf{Đánh giá tổng hợp:} Trên tập 20 ảnh kiểm thử, mô hình CNN OCR nhận dạng đúng 12 ảnh, tương ứng độ chính xác đạt 60\%, trong khi EasyOCR chỉ nhận dạng đúng 5 ảnh, tương ứng độ chính xác 25\%. Kết quả này cho thấy mô hình CNN được huấn luyện chuyên biệt cho bài toán biển số xe có hiệu năng vượt trội so với phương pháp OCR tổng quát EasyOCR trong bối cảnh dữ liệu thực tế phức tạp.
...
\end{tabular}
\end{table}
Dưới đây là bảng so sánh định tính giữa phương pháp đề xuất và các phương pháp truyền thống trong so sánh 2 ảnh đầu xe ô tô:
\begin{figure}[H]
    \centering
    \includegraphics[width=0.7\textwidth]{graphics/main/chapter2/siamese.jpg}
    \caption{Hình so sánh kết quả nhận dạng giữa ResNet và Siamese Network}
    \label{fig:siamese}
\end{figure}
