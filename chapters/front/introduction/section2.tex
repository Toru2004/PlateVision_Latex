...
\begin{itemize}
    \item Hệ thống AI tự động xử lý xe ra vào
    \begin{itemize}
        \item Triển khai mô hình AI của Deep Learning
    ...
    \begin{itemize}
        ...
        \item Kết nối thiết bị với vi điều khiển (ESP32) để truyền dữ liệu lên máy chủ.
    \end{itemize}
...
\subsection{Giới hạn phạm vi của đề tài}
    \begin{itemize}
        ...
        \item Tính năng thanh toán trực tuyến mới dừng lại ở thanh toán điện tử.
        \item Hệ thống bảo mật ở mức cơ bản, chưa đạt tiêu chuẩn thương mại hóa.
    \end{itemize}
\end{itemize}

Phạm vi nghiên cứu tập trung vào việc mô hình hóa hệ thống, xây dựng phiên bản thử nghiệm khả thi, đánh giá khả năng hoạt động của AI-App-IOT-Web trong một hệ thống tích hợp, làm cơ sở phát triển hoàn thiện trong tương lai.
