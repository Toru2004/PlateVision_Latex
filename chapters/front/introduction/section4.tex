...
\begin{unbulletedlist}
    ...
    \item \textbf{Chương 2: Xây dựng mô hình nghiên cứu}
    \item 
    \hspace*{1em} Chương này tập trung vào việc thiết kế và xây dựng mô hình hệ thống bãi đỗ xe thông minh, bao gồm các chức năng chính như nhận diện phương tiện thông qua camera (biển số xe, khuôn mặt đối với xe máy, so sánh hình ảnh ô tô bằng mô hình Siamese), điều khiển cổng tự động dựa trên nền tảng IoT và tích hợp thanh toán điện tử VNPAY. Trên cơ sở mô hình đã xây dựng, chương tiến hành kiểm thử hệ thống nhằm đánh giá hiệu năng xử lý, độ ổn định và khả năng đồng bộ dữ liệu, đồng thời phân tích các ưu điểm và những hạn chế còn tồn tại của hệ thống.

    \item \textbf{Chương 3: Kết luận và hướng phát triển}
    \item 
